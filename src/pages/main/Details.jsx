...
const NewsDetails = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 font-serif">
      ...
      {news.caption && <p className="text-xs text-gray-500 mb-4">{news.caption}</p>}
      <p className="text-gray-700 leading-relaxed mb-4">{news.longDescription || news.description}</p>
